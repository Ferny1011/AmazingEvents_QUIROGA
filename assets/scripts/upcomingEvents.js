...
downloadUpcomingEvents(data.events, data.currentDate);
for (let events of upcomingEvents) {     //this loop will create a card for each event in the upcomingEvents template.
...
function downloadUpcomingEvents(events, date) {
